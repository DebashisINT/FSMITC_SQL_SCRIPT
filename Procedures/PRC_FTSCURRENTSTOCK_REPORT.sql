...
3.0			v2.0.43		Priti		23/11/2023	    Dashboard report issue(check in local Rubyfoods db).Refer:0027031
****************************************************************************************************************************************************************************/
BEGIN
	SET NOCOUNT ON
	...
	SET @Strsql+='PROD.sProducts_Name AS PRODUCT,CSTKDET.Product_Qty AS QUANTITY,SHOPPP.Shop_Name AS ''PPName'''
	--Rev 3.0	
